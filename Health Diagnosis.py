...
final_preds = [mode([i, j, k, l])[0][0] for i, j, k, l in zip(svm_preds, nb_preds, rf_preds, lr_preds)] 
...
def predictDisease(symptoms): 
    ...
    final_prediction = mode([rf_prediction, nb_prediction, svm_prediction, lr_prediction])[0][0] 
    predictions = { 
